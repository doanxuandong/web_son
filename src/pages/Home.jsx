...
const Home = () => {
  ...
  return (
    <Fullpage scrollSensitivity={1} touchSensitivity={1} animationDuration={700}>
      <FullpageNavigation />
      <FullPageSections>
        {/* Section 1: Banner */}
        <FullpageSection style={{ height: '100vh', padding: 0 }}>
        ...
        <FullpageSection style={{ height: '100vh', padding: 0 }}>
          <div
            className="w-full h-full flex items-center justify-center relative bgr-sp-section"
            style={{
